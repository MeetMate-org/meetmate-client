...
export const IconTeam: React.FC<IconTeamProps> = ({ color = "#6B7280" }) => {
  return (
    ...
    >
      ...
      />
      <path
        d="M14 15C14 12.7909 12.2091 11 10 11C7.79086 11 6 12.7909 6 15V17H14V15Z"
        fill={color}
      />
      <path
        d="M18 17V15C18 13.9459 17.7282 12.9527 17.2507 12.0909C17.7346 11.9074 18.2558 11.8 18.8 11.8C20.5673 11.8 22 13.2327 22 15V17H18Z"
        fill={color}
      />
      <path
        d="M2 17V15C2 13.9459 2.27182 12.9527 2.74926 12.0909C2.26539 11.9074 1.74422 11.8 1.2 11.8C-0.567316 11.8 -2 13.2327 -2 15V17H2Z"
        fill={color}
      />
    </svg>
  );
